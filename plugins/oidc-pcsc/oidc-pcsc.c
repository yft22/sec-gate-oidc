...
static int pcscScardGet (oidcIdpT * idp, const oidcProfileT *profile, ulong pin, afb_hreq *hreq, struct afb_req_v4 *wreq)
{
    ...
    ulong tid= pcscMonitorReader (pcscOpts->handle, readerMonitorCB, (void*)pcscRqtCtx);
