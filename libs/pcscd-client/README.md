...
* SpringCore <https://www.springcard.com/en/learning/introduction-to-pc-sc-development> (`https://docs.springcard.com/books/SpringCore/PCSC_Operation/APDU_Interpreter/Command_list`)
