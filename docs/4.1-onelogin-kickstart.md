...
![registration](./onelogin/01-register-account.png)
...
![register-account](./onelogin/02-register-app.png)
...
![register-uri](./onelogin/03-register-uri.png)
...
```
![retrieve-clientid](./onelogin/04-clientid-secret.png)
...
![register-user](./onelogin/05-register-user.png)
...
![create-role](./onelogin/06-add-role.png)
...
![list-role](./onelogin/06-list-role.png)
...
![user-role](./onelogin/06-user-role.png)
...
![user-role](./onelogin/07-app-credentials.png)
