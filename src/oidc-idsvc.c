...
static void
idsvcPing (afb_req_t request, unsigned argc, afb_data_t const argv[])
{
    static int count = 0;
    char *response;
    afb_data_t reply;
...
static void
userCheckAttrCB (void *ctx, int status, unsigned argc, const afb_data_t argv[], afb_req_t request)
{
...
static void
userCheckAttr (afb_req_t request, unsigned argc, afb_data_t const argv[])
{
    int err;
...
// get result from /fedid/create-user
static void
userGetIdpsCB (void *ctx, int status, unsigned argc, const afb_data_t argv[], afb_req_t request)
{
    ...
    err = wrap_json_pack (&responseJ, "{ss so}", "target", alias->oidc->globals->fedlinkUrl, "idps", idpsJ);
...
static void
userGetIdps (afb_req_t request, unsigned argc, afb_data_t const argv[])
{
    int err;
...
// get result from /fedid/create-user
static void
userRegisterCB (void *ctx, int status, unsigned argc, const afb_data_t argv[], afb_req_t request)
{
...
static void
userRegister (afb_req_t request, unsigned argc, afb_data_t const argv[])
{
...
static void
sessionReset (afb_req_t request, unsigned argc, afb_data_t const argv[])
{
    afb_session *session = afb_req_v4_get_common (request)->session;
...
static void
sessionGet (afb_req_t request, unsigned argc, afb_data_t const argv[])
{
...
static void
subscribeEvent (afb_req_t request, unsigned argc, afb_data_t const argv[])
{
...
static void
idpsList (afb_req_t request, unsigned argc, afb_data_t const argv[])
{
    int err;
    afb_data_t reply;
...
// return the list of autorities matching requested LOA
static void
urlsList (afb_req_t request, unsigned argc, afb_data_t const argv[])
{
    int err;
    afb_data_t reply;
    ...
    err =
        wrap_json_pack (&responseJ, "{ss ss ss ss ss}", "login", oidc->globals->loginUrl, "fedlink", oidc->globals->loginUrl, "register",
                        oidc->globals->loginUrl, "remove", oidc->globals->loginUrl, "error", oidc->globals->errorUrl);
    if (err) goto OnErrorExit;
