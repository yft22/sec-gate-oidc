...
static void sessionGet (afb_req_x4_t request, unsigned nparams, afb_data_x4_t const params[]) {
...
static void subscribeEvent (afb_req_x4_t request, unsigned nparams, afb_data_x4_t const params[]) {
